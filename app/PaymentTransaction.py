...
class PaymentTransaction(object):
	...
	def process(self):
		...
		#retrieve output
		print ("Customer Identifier: %d, %d, %d \nName: %s, %s, %s \nAddress: %s, %s, %s, %s, %s \nPhone: %s \nSince: %s \nC_Credit: %s \nC_Credit_Lim: %s \nC_Discount: %s \nC_Balance: %s \n" % (self.c_w_id, self.c_d_id, self.c_id, selected_customer["c_first"], selected_customer["c_middle"], selected_customer["c_last"], selected_customer["c_address"]["c_street_1"],selected_customer["c_address"]["c_street_2"], selected_customer["c_address"]["c_city"], selected_customer["c_address"]["c_state"], selected_customer["c_address"]["c_zip"], selected_customer["c_phone"], selected_customer["c_since"], selected_customer["c_credit"],selected_customer["c_credit_lim"], selected_customer["c_discount"], c_balance_to_update))

		print ("warehouse address: %s, %s, %s, %s, %s \n" % (selected_warehouse_district["w_address"]["w_street_1"], selected_warehouse_district["w_address"]["w_street_2"], selected_warehouse_district["w_address"]["w_city"], selected_warehouse_district["w_address"]["w_state"], selected_warehouse_district["w_address"]["w_zip"]))
		
		print ("district address: %s, %s, %s, %s, %s \n" % (selected_warehouse_district["district"]["d_address"]["d_street_1"], selected_warehouse_district["district"]["d_address"]["d_street_2"], selected_warehouse_district["district"]["d_address"]["d_city"], selected_warehouse_district["district"]["d_address"]["d_state"], selected_warehouse_district["district"]["d_address"]["d_zip"]))
